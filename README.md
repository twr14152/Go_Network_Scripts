# Go_Network_Scripts
```Rather than redo this repository with go modules I've decided to start a new repository call go2run. It will hold the most usable scripts from this repo along with some new ones. Its a work in progress..``` 
